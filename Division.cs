...
namespace UnitTestProject2
{
    ...
    public class Division
    {
        ...
        */
        ...
        [TestMethod]
        public void Test_Composite_Integer_Division()
        {
        ...
        [TestMethod]
        public void Test_Double_Division()
        {
        ...
        [TestMethod]
        public void Test_Sin_Division()
        {
            aut.w.Keyboard.Enter("sin(pi)/sin(pi/2)");
            aut.w.Keyboard.HoldKey(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.RETURN);
            aut.w.Keyboard.LeaveKey(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.RETURN);
        }

        [TestMethod]
        public void Test_Cos_Division()
        {
            aut.w.Keyboard.Enter("cos(pi/2)/cos(pi)");
            aut.w.Keyboard.HoldKey(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.RETURN);
            aut.w.Keyboard.LeaveKey(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.RETURN);
        }
        ...
        [TestMethod]
        public void Test_8_Decimal_Division()
        {
        ...
        [TestMethod]
        public void Test_Fraction_Integer_Division()
        {
        ...
        [TestMethod]
        public void Test_Fraction_Decimal_Division()
        {
        ...
        [TestMethod]
        public void Test_Integer_Decimal_Division()
        {
